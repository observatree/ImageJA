...
public class Opener {
	...
	*/
	...
	public int getFileType(String path) {
		...
		// FITS ("SIMP")
		if ((b0==83 && b1==73 && b2==77 && b3==80) || name.endsWith(".fts.gz") || name.endsWith(".fits.gz") || name.endsWith(".fit.gz") || name.endsWith(".fz"))
			return FITS;
		...
		if (name.endsWith(".xls") || name.endsWith(".csv") || name.endsWith(".tsv") || name.endsWith(".dat") || name.endsWith(".tbl") || name.endsWith(".prn") || name.endsWith(".spc"))
			return TABLE;
